titulo.innerHTML = '01 - Introducción'
document.getElementById('texto').innerHTML='<p>Se utilizan para almacenar varios valores en una sola variable.</p><p>Sintaxis:</p><p>var nombre = new Array ("valor1", "valor2", "valor3");</p><p>var num = new Array (15,20,18);</p><p>var nombre = ["variable1", "variable2", "variable3"];</p>';
